...
![](+images/photo_windows.png)
  ...
  <div class="p-2">
    ...
    <p>Mostly used for web development work; gaming was minimal.</p>
    <p>The keyboard has RGB backlighting divided into 4 zones, 5 macro keys that can be assigned to anything, and a button to activate the fans at maximum speed.</p>
    <p>RGB lighting is also present on the sides.</p>
    <p>Overall, if you turn off the RGB lighting, it looks very understated compared to competitors.</p>
    <p>It has very good microphones and native noise cancellation, so in calls it performs even better than a headset.</p>
    <p>Notably, the HDMI port is connected directly to the Nvidia GPU for better performance, not to Intel as is usually done.</p>
