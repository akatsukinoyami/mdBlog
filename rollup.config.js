...
export default {
    ...
    copy({
      targets: [
        ...
        { src: 'node_modules/bootstrap/dist/js/bootstrap.bundle.min.js.map', dest: 'public/build' },
        { src: 'node_modules/bootstrap/dist/css/bootstrap.min.css.map', dest: 'public/build' }
      ],
      verbose: true
    }),
    css({ output: 'bundle.css' }), // We'll extract any component CSS out into a separate file - better for performance
